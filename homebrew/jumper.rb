...
class Jumper < Formula
  ...
  if Hardware::CPU.is_64_bit?
    ...
    when /mswin|msys|mingw|cygwin|bccwin|wince|emc/
      :windows
    when /darwin|mac os/
      url "https://github.com/asannikov/jumper/releases/download/1.5.1/jumper-darwin-amd64.zip"
      sha256 "9ed11c20a484b2bf5e549d5ec8cd28c37cbba914ab1a17be8177a38e4b2b6eb1"
    when /linux/
      url "https://github.com/asannikov/jumper/releases/download/1.5.1/jumper-linux-amd64.tar.gz"
    ...
    when /mswin|msys|mingw|cygwin|bccwin|wince|emc/
      :windows
    when /linux/
      url "https://github.com/asannikov/jumper/releases/download/1.5.1/jumper-linux-386.tar.gz"
